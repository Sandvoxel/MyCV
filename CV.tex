...
\begin{itemize}
\item Develop software to improve bussness efficiency.
\item Develop software to controle new props for rooms.
\item Designing microcontroler based circuits to control props in new rooms.
\end{itemize}

\divider

\cvevent{Ride Operator}{OWA}{Month 20XX -- Ongoing}{Location}
\begin{itemize}
